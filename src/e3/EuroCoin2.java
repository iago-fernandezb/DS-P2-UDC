...
public record EuroCoin2(int valueInCents, Country country, String design,CoinColor color, int year) {

    public EuroCoin2(int valueInCents, Country country, String design, CoinColor color, int year){
    ...
    public boolean equals(Object o) {
        ...
        EuroCoin2 euroCoin = (EuroCoin2) o;
